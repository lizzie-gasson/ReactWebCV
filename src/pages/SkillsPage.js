            ...
            <div className="article skills">
                ...
                <div className="text-section">
                    ...
                    <div className="text-group">
                        <h3>React</h3>
                        <p>I spent a few years learning React in my free time, then in 2021 I joined a team at IAG that uses React and since then my skills have continued to improve.
                        </p>
                    </div>

                    <div className="text-group">
                        <h3>React Native</h3>
                        <p>I have been learning React Native in my personal development time by working through courses on udemy and creating my own projects outside of work. I'm currently creating a simple language learning app using react native (see my projects section).
                        </p>
                    </div>

                    <div className="text-group">
                        <h3>Typescript</h3>
                        <p>I started using Typescript in 2021 in one of my teams, and although it seemed like extra work at first, I quickly came to appreciate the assistance it provides you while programming, I continue to use it in my personal projects.
                        </p>
                    </div>

                    <div className="text-group">
                        <h3>Javascript</h3>
                        <p>I have used the language regularly since working at IAG along with libraries and frameworks like JQuery. I also did a course on udemy about javascript to really understand and break down the programming language.
                        </p>
                    </div>
                ...
                <div className="text-section">
                    ...
                    <div className="text-group">
                        <h3>Agile</h3>
                        <p>I have worked in various scrum teams and used the agile methodology on a daily basis. I’ve learned a lot about the processes and meetings that take place, and I have experienced first hand the benefits as well as the challenges that come with it.</p>
                    </div>
